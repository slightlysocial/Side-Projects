...
@implementation ZombieGreen

-(id)init {
    if ((self = [super initWithSpriteFrameName:@"enemy_ninjaRed_stand_1.png"])) {
        int i;
        ...
        for (i = 0; i < 1; i++) {
            CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"enemy_ninjaRed_stand_%d.png", i+1]];
        ...
        */
        ...
        for (i = 0; i < 2; i++) {
            CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"enemy_ninjaRed_attack_%d.png", i+1]];
        ...
        */
        ...
        for (i = 0; i < 3; i++) {
            CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"zombieGreen_walk_1_%d.png", i+1]];
        ...
        walkFrames = [CCArray arrayWithCapacity:3];
        for (i = 0; i < 3; i++) {
            CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"zombieGreen_walk_2_%d.png", i+1]];
            [walkFrames addObject:frame];
        }
        walkAnimation = [CCAnimation animationWithSpriteFrames:[walkFrames getNSArray] delay:1.0/12.0];
        ...
        walkFrames = [CCArray arrayWithCapacity:3];
        for (i = 0; i < 3; i++) {
            CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"zombieGreen_walk_3_%d.png", i+1]];
            [walkFrames addObject:frame];
        }
        walkAnimation = [CCAnimation animationWithSpriteFrames:[walkFrames getNSArray] delay:1.0/12.0];
        ...
        for (i = 0; i < 2; i++) {
            CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"enemy_ninjaRed_hurt_%d.png", i+1]];
        ...
        */
        ...
        for (i = 0; i < 6; i++) {
            if(i<=3)
            {
                CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"enemy_ninjaRed_die_%d.png", i+1]];
        ...
        */
        ...
        self.walkSpeed = WALKSPEED_RED_NINJA;
        self.centerToBottom = 39.0;
        self.centerToSides = 29.0;
        self.hitPoints = HEALTH_POINTS_RED_NINJA;
        self.damage = DAMAGE_POINTS_RED_NINJA;
