...
{
    [Flurry startSession:@"D5BR36VF4SHQN99XD2M7"];
...
//	[director setProjection:kCCDirectorProjection3D];
	...
	gGamesMusicStatus = TRUE;//Meng added
    gGamesEffectStatus = TRUE;//Meng added
    [director_ runWithScene: [GameMenu scene]];
...
-(void) applicationDidEnterBackground:(UIApplication*)application
{
    ...
    GamePauseScene *GameScene = [GamePauseScene node];
