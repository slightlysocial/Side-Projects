...
- (void) saveScoreToGameCenter: (int) score {
    ...
    [localPlayer authenticateWithCompletionHandler:^(NSError *error) {
        if (localPlayer.isAuthenticated)
        {
            ...
            //com.slightlysocial.goatfeedtrucker.100000
            //com.slightlysocial.goatfeedtrucker.50000
            //Update achievements
            if (score > 100000)
            {
                GKAchievement *achievement;
                achievement= [[[GKAchievement alloc] initWithIdentifier:@"com.slightlysocial.goatfeedtrucker.100000"] autorelease];
            ...
            {
                GKAchievement *achievement;
                achievement= [[[GKAchievement alloc] initWithIdentifier:@"com.slightlysocial.goatfeedtrucker.50000"] autorelease];
                achievement.percentComplete = 100.0;
            ...
            {
                GKAchievement *achievement;
                achievement= [[[GKAchievement alloc] initWithIdentifier:@"com.slightlysocial.goatfeedtrucker.25000"] autorelease];
                achievement.percentComplete = 100.0;
            ...
            {
                GKAchievement *achievement;
                achievement= [[[GKAchievement alloc] initWithIdentifier:@"com.slightlysocial.goatfeedtrucker.10000"] autorelease];
                achievement.percentComplete = 100.0;
            ...
            {
                GKAchievement *achievement;
                achievement= [[[GKAchievement alloc] initWithIdentifier:@"com.slightlysocial.goatfeedtrucker.5000"] autorelease];
                achievement.percentComplete = 100.0;
