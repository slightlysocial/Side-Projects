...
@synthesize scores, achievements, internetConnectionAvailable, gameCenterAvailable, gameCenterPlayerLoggedIn;
...
-(id) init {
	if (self = [super init]) {
		...
		scoreCategories = [[NSMutableArray alloc] initWithObjects: @"FSC", @"FSA", @"FSZ", nil];
		achievementIdentifiers = [[NSMutableArray alloc] initWithObjects: @"FSA1", @"FSA2", @"FSA3", @"FSA4", @"FSA5", @"FSA6", @"FSA7", nil];
