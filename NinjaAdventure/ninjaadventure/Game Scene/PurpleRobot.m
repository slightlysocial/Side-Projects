...
@implementation PurpleRobot

-(id)init {
    if ((self = [super initWithSpriteFrameName:@"enemy_ninjaPurple_stand_1.png"])) {
        int i;
        
        //idle animation
        CCArray *idleFrames = [CCArray arrayWithCapacity:1];
        for (i = 0; i < 1; i++) {
            CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"enemy_ninjaPurple_stand_%d.png", i+1]];
        ...
        for (i = 0; i < 2; i++) {
            CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"enemy_ninjaPurple_attack_%d.png", i+1]];
        ...
        for (i = 0; i < 2; i++) {
            CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"enemy_ninjaPurple_run_%d.png", i+1]];
        ...
        for (i = 0; i < 2; i++) {
            CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"enemy_ninjaPurple_hurt_%d.png", i+1]];
        ...
        for (i = 0; i < 6; i++) {
            if(i<=3)
            {
                CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"enemy_ninjaPurple_die_%d.png", i+1]];
        ...
        self.walkSpeed = WALKSPEED_PURPLE_NINJA;
        self.centerToBottom = 39.0;
        self.centerToSides = 29.0;
        self.hitPoints = HEALTH_POINTS_PURPLE_NINJA;
        self.damage = DAMAGE_POINTS_PURPLE_NINJA;
