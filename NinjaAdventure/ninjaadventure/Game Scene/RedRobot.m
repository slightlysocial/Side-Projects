...
-(id)init {
    if ((self = [super initWithSpriteFrameName:@"enemy_ninjaRed_stand_1.png"])) {
        ...
        for (i = 0; i < 2; i++) {
            CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"enemy_ninjaRed_run_%d.png", i+1]];
